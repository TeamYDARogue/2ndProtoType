...
public class FieldManager : Token
{
    /*
...
　　シングルトン化
    */
	...
	public static TokenMgr<FieldManager> parent = null;

	public static FieldManager Add(int id,float X,float z){
		if (parent == null) {
			parent = new TokenMgr<FieldManager> ("FieldManager");
		}
		var t = parent.Add (X, z);
		//t.CreateStage(id);
		return t;
	}
    enum FieldType
            ...
            for (int y = 0; y < layer.Height; y++)
            {
                switch (layer.Get(x, y))
                {
                    ...
                    case (int)FieldType.Vase:
                        //壺
                        Instantiate(ResourceManager.Instance.GetResourceScene("Vase"), new Vector3(x, 0.5f, y), Quaternion.identity);
                        break;
                    ...
                    case (int)FieldType.Save:
                        //セーブ
                        Instantiate(ResourceManager.Instance.GetResourceScene("Save"), new Vector3(x, 0.5f, y), Quaternion.identity);
                        break;
                    case (int)FieldType.Exit:
                        //出口
                        Instantiate(ResourceManager.Instance.GetResourceScene("Exit"), new Vector3(x, 0.5f, y), Quaternion.identity);
                        break;
                    ...
                    case (int)FieldType.Player:
                        //プレイヤー
                        Instantiate(ResourceManager.Instance.GetResourceScene("Player"), new Vector3(x, 0.6f, y), Quaternion.identity);
                        break;
                    ...
                    case (int)FieldType.Enemy_b:
                        //敵B
                        Instantiate(ResourceManager.Instance.GetResourceScene("Enemy_b"), new Vector3(x, 0.6f, y), Quaternion.identity);
                        break;
                }
            }
        }
